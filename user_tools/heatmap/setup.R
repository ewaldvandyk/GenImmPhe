...
setup_data_sources <- function(){
  input_dir <- "/Volumes/Ewald/Antoinette/TCGA/all"
  output_dir <- "~/temp/heatmap"
  input_data_sources  <- 
  ...
  data_sources <- list(input_dir=input_dir, input_data_sources=input_data_sources, 
                       cluster_on=cluster_on)
  return(data_sources)
}


setup_heatmap <-function(df_list){
  paramList <- list()
